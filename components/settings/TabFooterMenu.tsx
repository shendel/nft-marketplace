...
import { sysMenus, defFooterMenus } from "../../appconfig/menu"
...
export default function TabMenu(options) {
  ...
  const [ menuItems, setMenuItems ] = useState(storageFooterMenu && storageFooterMenu.length ? storageFooterMenu : defFooterMenus)
